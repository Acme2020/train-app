...
vi.mock("../../helpers/station/filterByDuration", () => ({
  filterByDuration: vi.fn(),
}));

describe("StationService", () => {
  let stationService: StationServiceImpl;
  ...
  describe("searchStations", () => {
    ...
    describe("getStationBoard", () => {
      ...
      it("should throw InvalidStationIdError for empty station ID", async () => {
        // Act & Assert
      ...
      it("should handle API errors for arrivals", async () => {
        // Arrange
        mockDbClient.departures.mockResolvedValue({ departures: [] });
        mockDbClient.arrivals.mockRejectedValue(
          new Error("Arrivals API Error")
        );
